...
class AppUnderMaintenanceException implements Exception {
  final String message;
  AppUnderMaintenanceException({this.message = 'exception: maintenance Mode'});
}
...
// this exception thrown when you need user to logout from your application
class ForceLogoutException implements Exception {
  final String message;
  ForceLogoutException({this.message = "exception: force logout"});
